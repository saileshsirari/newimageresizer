 ...
 */
final public class BitmapLoadingWorkerTask extends AsyncTask<Void, Void, BitmapLoadingWorkerTask.Result> {
    ...
    public BitmapLoadingWorkerTask(CropImageView cropImageView, Uri uri, int maxWidth, int maxHeight) {
        mUri = uri;
        mCropImageViewReference = new WeakReference<>(cropImageView);
