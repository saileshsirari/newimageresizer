 ...
 */
public class CropImageView extends FrameLayout implements CropOverlayView.OnCropRectChangedListener {
    ...
    OnCropRectChangedListener mOnCropRectChangedListener;
    /**
    ...
    private OnSetImageBitmapUriCompleteListener mOnSetImageBitmapUriCompleteListener;
...
//            options.maxCropResultWidth =400;
//            options.maxCropResultHeight =400;
//
//            options.fixAspectRatio=true;

//            options.minCropResultWidth =100;
//            options.maxCropResultHeight =100;
        ...
        mCropOverlayView.setOnCropRectChangedListener(this);
    ...
    public void OnCropRectChanged(RectF rect) {
        if (mOnCropRectChangedListener != null) {
            mOnCropRectChangedListener.OnCropRectChanged(rect);
        }
    }

    public void setOnCropRectChangedListener(OnCropRectChangedListener mOnCropRectChangedListener) {
        this.mOnCropRectChangedListener = mOnCropRectChangedListener;
    }
    ...
    public void setOnSetImageBitmapUriCompleteListener(OnSetImageBitmapUriCompleteListener mOnSetImageBitmapUriCompleteListener) {
        this.mOnSetImageBitmapUriCompleteListener = mOnSetImageBitmapUriCompleteListener;
    }
...
//        mOnSetImageBitmapUriCompleteListener.onSetImageUriComplete(this,result.bitmap,result.error);
        }
     ...
     * Interface definition for a callback to be invoked when image async loading is complete.
     */
    public interface OnSetImageBitmapUriCompleteListener {
         ...
         * @param error  if error occurred during loading will contain the error, otherwise null.
         */
        void onSetImageUriComplete(CropImageView view, Bitmap bitmap, Exception error);
    }
    // endregion
